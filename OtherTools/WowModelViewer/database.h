...
/*
enum {
	CharRacesDB_RaceID = 0,		// uint
	CharRacesDB_ShortName = 6,	// string
	CharRacesDB_Name = 15,		// string
	CharRacesDB_FullName = 17,	// string
	CharRacesDB_GeoType1 = 26,	// string
	CharRacesDB_GeoType2 = 27,	// string
	CharRacesDB_GeoType3 = 28	// string
};
*/
...
public:
	...
	{
		/*
		// If they have/loaded the expansion, 
		// then change the values to point to the correct columns
		if (hasExpansion) {
			CharRacesDB_Name = 12;		// string
			CharRacesDB_FullName = 15;	// string
			CharRacesDB_GeoType1 = 23;	// string
			CharRacesDB_GeoType2 = 24;	// string
			CharRacesDB_GeoType3 = 25;	// string
		}
		*/
	}
	...
	static const size_t GeoType1 = 23;	// string
	static const size_t GeoType2 = 24;	// string
	static const size_t GeoType3 = 25;	// string
...
public:
	...
	Record getByFilename(std::string fn, bool &bFind);
	Record getByID(unsigned int id);
private:
...
public:
	...
	// Changed in WoW 2.0.1, the 20th column is now an index offset to the filename.  18 is null?
