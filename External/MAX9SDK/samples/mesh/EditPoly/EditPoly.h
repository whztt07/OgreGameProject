...
const Class_ID kEDIT_MOD_CLASS_ID(0x79aa6e1d, 0x71a075b7);
...
class EditPolyActionCB : public ActionCallback {
	EPolyMod *mpMod;
public:
	EditPolyActionCB (EPolyMod *m) : mpMod(m) { }
	BOOL ExecuteAction(int id);
};

class EditPolyMod : public Modifier, public IMeshSelect, public EPolyMod,
	public EventUser, public AttachMatDlgUser, public MeshPaintHandler {
...
public:
	...
	void EpModCommit (TimeValue t, bool macroRecord, bool clearAfter=true);
...
class EditPolyCreateFaceMouseProc : public MouseCallBack {
friend class EditPolyCreateFaceCMode;
	EPolyMod		*mpEPoly;
	IObjParam		*ip;
	Tab<int>		vts;
	Tab<IPoint2>	mpts;
...
public:
	EditPolyCreateFaceMouseProc(EPolyMod* e, IObjParam *i) : mpEPoly(e), ip(i) { }
