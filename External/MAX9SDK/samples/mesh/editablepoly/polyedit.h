...
enum { ep_select, ep_softsel, ep_geom, ep_geom_vertex, ep_geom_edge,
	...
	ep_advanced_displacement, ep_settings, ep_paintdeform };
...
class EditPolyObject : public PolyObject, public EventUser, public ISubMtlAPI,
			...
			public IMeshSelectData, public MeshPaintHandler, public MeshPaintHost
{
...
class CreateOnlyRestore : public RestoreObj {
	...
	Tab<MNNormalFace> mNewNormFaces;
	Tab<UVVert> *nmverts;
...
TCHAR *LookupEditablePolySelLevel (int opID);
