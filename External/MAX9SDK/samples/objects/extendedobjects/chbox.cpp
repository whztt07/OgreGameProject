...
class ChBoxObject : public SimpleObject, public IParamArray, public RealWorldMapSizeInterface {
	public:
		// Class vars
...
class ChBoxParamDlgProc : public ParamMapUserDlgProc {
	public:
		ChBoxObject *ob;
        HWND mhWnd;
...
/*top chamfer + top face(2 faces/seg)(*2 for bottom) plus any depth faces*/
	...
	float udiv=usePhysUVs ? 1.0f : 2.0f*xmax,vdiv=usePhysUVs ? 1.0f :2.0f*ymax,u,v;
