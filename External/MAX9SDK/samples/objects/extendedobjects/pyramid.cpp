...
class PyramidObject : public SimpleObject, public IParamArray, public RealWorldMapSizeInterface {
	public:
		// Class vars
		...
		Class_ID ClassID() { return PYRMID_CLASS_ID; }  		
...
class PyramidParamDlgProc : public ParamMapUserDlgProc {
	public:
...
void PyramidParamDlgProc::Update()
{
...
void PyramidObject::BeginEditParams(IObjParam *ip,ULONG flags,Animatable *prev)
	...
	if(pmapParam) {
		// A callback for the type in.
		pmapParam->SetUserDlgProc(new PyramidParamDlgProc(this));
		}
	}
