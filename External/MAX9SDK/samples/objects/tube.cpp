...
class TubeObject : public SimpleObject, public IParamArray, public RealWorldMapSizeInterface {
	public:
		// Class vars
...
void TubeObject::BeginEditParams( IObjParam *ip, ULONG flags,Animatable *prev )
	...
	if (pmapCreate && pmapParam && pmapTypeIn) {
        ...
        TubeParamDlgProc* dlg = static_cast<TubeParamDlgProc*>(pmapParam->GetUserDlgProc());
        if (dlg != NULL) {
