...
class ConeObject : public SimpleObject, public IParamArray, public RealWorldMapSizeInterface  {
	public:
		// Class vars
...
ConeObject::ConeObject(BOOL loading) 
	{
...
void ConeObject::BeginEditParams(IObjParam *ip,ULONG flags,Animatable *prev)
	...
	if (pmapCreate && pmapParam) {
        ...
        ConeParamDlgProc* dlg = static_cast<ConeParamDlgProc*>(pmapParam->GetUserDlgProc());
        if (dlg != NULL) {
