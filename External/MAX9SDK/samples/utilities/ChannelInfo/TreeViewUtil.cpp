...
static ChannelInfoFunctionPublish theChannelInfoFunctionPublish(
	...
	ChannelInfoFunctionPublish::kCloseDialog, _T("closeDialog"), -1, TYPE_VOID, 0, 0,
	ChannelInfoFunctionPublish::kIsChecked, _T("isChecked"), -1, TYPE_BOOL, 0, 0,
...
public:		   				
	...
	void Restore(int isUndo) {
		if (mOnlyForRedo) {
			if (mMode = GetCOREInterface7()->InManipMode()) {
