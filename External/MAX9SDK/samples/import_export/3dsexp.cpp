...
class _My3DSExport : public SceneExport {
...
class _3DSClassDesc:public ClassDesc {
	...
	void *			Create(BOOL loading = FALSE) { return new _My3DSExport; }
	const TCHAR *	ClassName() { return GetString(IDS_TH_3DSTUDIO); }
	SClass_ID		SuperClassID() { return SCENE_EXPORT_CLASS_ID; }
	Class_ID		ClassID() { /*return Class_ID(0xd1d,0);*/return Class_ID(0x674553da, 0x345ce7b0); }
...
int
_My3DSExport::ExtCount() {
	return 1;
	}

const TCHAR *
_My3DSExport::Ext(int n) {		// Extensions supported for import/export modules
	switch(n) {
		case 0:
			return _T("My3DS");
		}
...
const TCHAR *
_My3DSExport::LongDesc() {			// Long ASCII description (i.e. "Targa 2.0 Image File")
	return _T("");
	//return GetString(IDS_TH_3DSSCENEFILE);
	}
	
const TCHAR *
_My3DSExport::ShortDesc() {			// Short ASCII description (i.e. "Targa")
	return _T("My3DS File");
	//return GetString(IDS_TH_3DSFILE);
	}

const TCHAR *
_My3DSExport::AuthorName() {			// ASCII Author name
	return _T("");
	//return GetString(IDS_TH_TOM_HUDSON);
	}

const TCHAR *
_My3DSExport::CopyrightMessage() {	// ASCII Copyright message
	return _T("");
	//return GetString(IDS_TH_COPYRIGHT_YOST_GROUP);
	}

const TCHAR *
_My3DSExport::OtherMessage1() {		// Other message #1
	return _T("");
	}

const TCHAR *
_My3DSExport::OtherMessage2() {		// Other message #2
	return _T("");
	}

unsigned int
_My3DSExport::Version() {				// Version number * 100 (i.e. v3.01 = 301)
	return 200;
	}

void
_My3DSExport::ShowAbout(HWND hWnd) {			// Optional
 	}

static INT_PTR CALLBACK
ExportOptionsDlgProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam) {
	static _My3DSExport* exp;

	switch(message) {
		case WM_INITDIALOG:
			SetWindowContextHelpId(hDlg, idh_3dsexp_export);
            exp = (_My3DSExport*) lParam;
...
int
_3ds_save(const TCHAR *filename, ExpInterface *ei, Interface *gi, _My3DSExport* exp) {
...
int
_My3DSExport::DoExport(const TCHAR *filename,ExpInterface *ei,Interface *gi, BOOL suppressPrompts, DWORD options) {
...
BOOL _My3DSExport::SupportsOptions(int ext, DWORD options) {
