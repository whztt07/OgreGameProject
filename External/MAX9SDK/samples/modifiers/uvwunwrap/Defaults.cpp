...
//5.1.06
	...
	str.printf("%d",thickOpenEdges);
	WritePrivateProfileString(WSDSECTION,THICKOPENEDGES,str,filename);

	str.printf("%d",viewportOpenEdges);
	WritePrivateProfileString(WSDSECTION,VIEWPORTOPENEDGES,str,filename);

	str.printf("%d",this->absoluteTypeIn);
	WritePrivateProfileString(WSDSECTION,ABSOLUTETYPEIN,str,filename);

	str.printf("%d",bStitchScale);
	WritePrivateProfileString(WSDSECTION,STITCHSCALE,str,filename);

	str.printf("%d",rotationsRespectAspect);
	WritePrivateProfileString(WSDSECTION,ROTATIONSRESPECTASPECT,str,filename);


	str.printf("%d",move);
	WritePrivateProfileString(WSDSECTION,MOVE,str,filename);

	str.printf("%d",scale);
	WritePrivateProfileString(WSDSECTION,SCALE,str,filename);

	str.printf("%d",mirror);
	WritePrivateProfileString(WSDSECTION,MIRROR,str,filename);
	
	str.printf("%d",uvw);
	WritePrivateProfileString(WSDSECTION,UVW,str,filename);

	str.printf("%d",pixelSnap);
	WritePrivateProfileString(WSDSECTION,PIXELSNAP,str,filename);

	str.printf("%d",fnGetGridSnap());
	WritePrivateProfileString(WSDSECTION,GRIDSNAP,str,filename);

	if (iSnap)
	{
		str.printf("%d",iSnap->GetCurFlyOff());
		WritePrivateProfileString(WSDSECTION,SNAPSTATE,str,filename);
	}

	str.printf("%d",zoomext);
	WritePrivateProfileString(WSDSECTION,ZOOMEXTENT,str,filename);

	str.printf("%d",TVSubObjectMode);
	WritePrivateProfileString(WSDSECTION,TVSUBOBJECTMODE,str,filename);

	str.printf("%f",relaxBySpringStretch);
	WritePrivateProfileString(WSDSECTION,RELAXBYSPRINGSTRETCH,str,filename);

	str.printf("%d",relaxBySpringIteration);
	WritePrivateProfileString(WSDSECTION,RELAXBYSPRINGITERATION,str,filename);


	str.printf("%f",this->relaxStretch);
	WritePrivateProfileString(WSDSECTION,RELAXSTRETCH,str,filename);

	str.printf("%d",this->relaxType);
	WritePrivateProfileString(WSDSECTION,RELAXTYPE,str,filename);

	int width;
	pblock->GetValue(unwrap_renderuv_width,0,width,FOREVER);
	str.printf("%d",width);
	WritePrivateProfileString(WSDSECTION,RENDERTEMPLATE_WIDTH,str,filename);


	int height;
	pblock->GetValue(unwrap_renderuv_height,0,height,FOREVER);
	str.printf("%d",height);
	WritePrivateProfileString(WSDSECTION,RENDERTEMPLATE_HEIGHT,str,filename);


 	Color edgeColor;
	pblock->GetValue(unwrap_renderuv_edgecolor,0,edgeColor,FOREVER);
	str.printf("%f %f %f",edgeColor.r,edgeColor.g,edgeColor.b);
	WritePrivateProfileString(WSDSECTION,RENDERTEMPLATE_EDGECOLOR,str,filename);

	float edgeAlpha;
	pblock->GetValue(unwrap_renderuv_edgealpha,0,edgeAlpha,FOREVER);
	str.printf("%f",edgeAlpha);
	WritePrivateProfileString(WSDSECTION,RENDERTEMPLATE_EDGEALPHA,str,filename);

 	Color seamColor;
	pblock->GetValue(unwrap_renderuv_seamcolor,0,seamColor,FOREVER);
	str.printf("%f %f %f",seamColor.r,seamColor.g,seamColor.b);
	WritePrivateProfileString(WSDSECTION,RENDERTEMPLATE_SEAMCOLOR,str,filename);

	int r;
	pblock->GetValue(unwrap_renderuv_visible,0,r,FOREVER);
	str.printf("%d",r);
	WritePrivateProfileString(WSDSECTION,RENDERTEMPLATE_RENDERVISIBLEEDGES,str,filename);

	pblock->GetValue(unwrap_renderuv_invisible,0,r,FOREVER);
	str.printf("%d",r);
	WritePrivateProfileString(WSDSECTION,RENDERTEMPLATE_RENDERINVISIBLEEDGES,str,filename);

	pblock->GetValue(unwrap_renderuv_seamedges,0,r,FOREVER);
	str.printf("%d",r);
	WritePrivateProfileString(WSDSECTION,RENDERTEMPLATE_RENDERSEAMEDGES,str,filename);


	pblock->GetValue(unwrap_renderuv_showframebuffer,0,r,FOREVER);
	str.printf("%d",r);
	WritePrivateProfileString(WSDSECTION,RENDERTEMPLATE_SHOWFRAMEBUFFER,str,filename);

	pblock->GetValue(unwrap_renderuv_force2sided,0,r,FOREVER);
	str.printf("%d",r);
	WritePrivateProfileString(WSDSECTION,RENDERTEMPLATE_FORCE2SIDED,str,filename);


	pblock->GetValue(unwrap_renderuv_fillmode,0,r,FOREVER);
	str.printf("%d",r);
	WritePrivateProfileString(WSDSECTION,RENDERTEMPLATE_FILLMODE,str,filename);

	float fillAlpha;
	pblock->GetValue(unwrap_renderuv_fillalpha,0,fillAlpha,FOREVER);
	str.printf("%f",fillAlpha);
	WritePrivateProfileString(WSDSECTION,RENDERTEMPLATE_FILLALPHA,str,filename);

 	Color fillColor;
	pblock->GetValue(unwrap_renderuv_fillcolor,0,fillColor,FOREVER);
	str.printf("%f %f %f",fillColor.r,fillColor.g,fillColor.b);
	WritePrivateProfileString(WSDSECTION,RENDERTEMPLATE_FILLCOLOR,str,filename);


	pblock->GetValue(unwrap_renderuv_overlap,0,r,FOREVER);
	str.printf("%d",r);
	WritePrivateProfileString(WSDSECTION,RENDERTEMPLATE_OVERLAP,str,filename);

 	Color overlapColor;
	pblock->GetValue(unwrap_renderuv_overlapcolor,0,overlapColor,FOREVER);
	str.printf("%f %f %f",overlapColor.r,overlapColor.g,overlapColor.b);
	WritePrivateProfileString(WSDSECTION,RENDERTEMPLATE_OVERLAPCOLOR,str,filename);
