...
#define MAXVER_INTERNALNAME "PFlowASMActions\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "ParticleActions3.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "PFlow ASM Actions\0"//should  be overidden on a per-dll level
