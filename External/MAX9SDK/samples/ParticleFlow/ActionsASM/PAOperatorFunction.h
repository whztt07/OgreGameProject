...
#ifndef _PAOPERATORFUNCTION_H_
#define _PAOPERATORFUNCTION_H_
...
class PAOperatorFunction:	public PFSimpleOperator 
{
public:
	PAOperatorFunction();
