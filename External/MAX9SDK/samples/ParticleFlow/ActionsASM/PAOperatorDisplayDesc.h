...
#ifndef  _PAOPERATORDISPLAYDESC_H_
#define  _PAOPERATORDISPLAYDESC_H_
...
class PAOperatorDisplayDesc: public ClassDesc2 {
	public:
	~PAOperatorDisplayDesc();
	int 			IsPublic();
...
#endif // _PAOPERATORDISPLAYDESC_H_