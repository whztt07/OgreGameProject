...
#ifndef  _PAOPERATORCOPYDESC_H_
#define  _PAOPERATORCOPYDESC_H_
...
class PAOperatorCopyDesc: public ClassDesc2 {
	public:
	~PAOperatorCopyDesc();
	int 			IsPublic();
