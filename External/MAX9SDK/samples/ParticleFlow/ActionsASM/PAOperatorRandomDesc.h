...
#ifndef  _PAOPERATORRANDOMDESC_H_
#define  _PAOPERATORRANDOMDESC_H_
...
class PAOperatorRandomDesc: public ClassDesc2 {
	public:
	~PAOperatorRandomDesc();
	int 			IsPublic();
...
#endif // _PAOPERATORRANDOMDESC_H_