...
#ifndef _PAOPERATORDISPLAY_H_
#define _PAOPERATORDISPLAY_H_
...
class PAOperatorDisplay:	public HelperObject, 
							public IPFAction,
							public IPFOperator,
							public IPFViewport,
							public IPViewItem
...
protected:
		...
		void UpdatePViewUI(int updateID, int tabIndex=0) const;
