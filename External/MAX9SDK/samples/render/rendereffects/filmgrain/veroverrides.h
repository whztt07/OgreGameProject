...
#define MAXVER_INTERNALNAME "FilmGrain\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "FilmGrain.dlf\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Film grain rendering effect (plugin)\0"//should  be overidden on a per-dll level
...
#define MAXVER_COPYRIGHT "Copyright © 1993, 1998 Gus J Grubba.\0"//only in exceptions should this be overridden
