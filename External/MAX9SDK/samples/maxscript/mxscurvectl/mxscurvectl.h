...
#ifndef __MXSCURVECTL__H
#define __MXSCURVECTL__H
...
#	define				is_ccroot(p) ((p)->tag == class_tag(CCRootClassValue))
...
public:
	...
	void		collect() { delete this; }
#	define		is_curvepoint(p) ((p)->tag == class_tag(CurvePointValue))
...
public:
	...
	void		sprin1(CharStream* s);
	void		gc_trace();
#	define		is_curve(p) ((p)->tag == class_tag(MAXCurve))
