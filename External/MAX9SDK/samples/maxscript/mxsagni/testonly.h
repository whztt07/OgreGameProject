...
/*def_struct_primitive( IsTrialLicense,			testonly, "IsTrialLicense");
def_struct_primitive( IsEmergencyLicense,		testonly, "IsEmergencyLicense");
def_struct_primitive( IsNetworkLicense,			testonly, "IsNetworkLicense");*/
