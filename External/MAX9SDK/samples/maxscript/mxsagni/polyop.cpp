...
// ============================================================================
// setVert <Poly poly> <vertlist> <point3 pos> node:<node>
Value*
...
// ============================================================================
// moveVert <Poly poly> <vertlist> <point3 offset> node:<node>
Value*
polyop_moveVert_cf(Value** arg_list, int count)
{
	...
	BitArray verts (nVerts);
	ValueToBitArrayP(arg_list[1], verts, nVerts, GetString(IDS_POLY_VERTEX_INDEX_OUT_OF_RANGE), MESH_VERTSEL_ALLOWED, poly);
	Point3 offset =  arg_list[2]->to_point3(); // CONVERT TO LOCAL COORDINATES!!!
	Value* inNode = key_arg(node);
...
//	else world_from_current_coordsys(offset);
	EPoly *epi = (EPoly*)((Animatable*)owner)->GetInterface(EPOLY_INTERFACE);
	if (epi) {
