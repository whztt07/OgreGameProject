...
class BendMod : public SimpleMod2 {	
	public:
		...
		void GetClassName(TSTR& s) { s= GetString(IDS_RB_BEND_OSM_CLASS); }  
...
class BendClassDesc:public ClassDesc2 {
	...
	const TCHAR *	ClassName() { return GetString(IDS_RB_BEND_OSM_CLASS); }
...
class BendWSMClassDesc:public ClassDesc2 {
	...
	const TCHAR *	ClassName() { return GetString(IDS_RB_BEND_WSM_CLASS); }
	SClass_ID		SuperClassID() { return WSM_OBJECT_CLASS_ID; }
	Class_ID		ClassID() { return BENDWSM_CID; }
