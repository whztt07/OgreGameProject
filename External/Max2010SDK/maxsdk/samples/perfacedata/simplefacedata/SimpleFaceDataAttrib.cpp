...
#include "maxscrpt\funcs.h" // convert to/from fpvalue/value
...
//-----------------------------------------------------------------------------
void SimpleFaceDataAttrib::BeginEditParams(IObjParam *ip,ULONG flags,Animatable *prev)
//-----------------------------------------------------------------------------
{
}

//-----------------------------------------------------------------------------
void SimpleFaceDataAttrib::EndEditParams(IObjParam *ip, ULONG flags, Animatable *next)
//-----------------------------------------------------------------------------
{
}
...
//-----------------------------------------------------------------------------
{
	...
	break;
	case TYPE_POINT2_BV:
		pChan = new SimpleFaceChannel<TYPE_POINT2_BV_TYPE>(type, size, Point2((float)0,0));
	break;
	case TYPE_POINT3_BV:
