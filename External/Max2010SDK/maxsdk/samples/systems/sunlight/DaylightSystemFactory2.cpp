...
// Should avoid static variables at global scope - order of initialization of global vars is undefined. 
DaylightSystemFactory2 DaylightSystemFactory2::mTheDaylightSystemFactory (
...
{
	return mTheDaylightSystemFactory;
}
