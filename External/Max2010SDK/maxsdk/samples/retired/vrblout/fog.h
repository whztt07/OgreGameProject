...
#define Fog_CLASS_ID1 0x39df51ea
#define Fog_CLASS_ID2 0x8d9588b
...
class FogObject: public HelperObject {			   
  ...
  public:
    ...
    TCHAR *GetObjectName() { return _T("Fog"); }


    // From Object
           ObjectState Eval(TimeValue time);
    void InitNodeName(TSTR& s) { s = _T("Fog"); }
    ...
    Class_ID ClassID() { return Class_ID(Fog_CLASS_ID1,
                                         Fog_CLASS_ID2);}  
    void GetClassName(TSTR& s) { s = TSTR(_T("Fog")); }
