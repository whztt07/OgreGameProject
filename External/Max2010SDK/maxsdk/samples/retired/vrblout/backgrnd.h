...
#define Background_CLASS_ID1 0x7314161d
#define Background_CLASS_ID2 0x1aab7e36
...
class BackgroundObject: public HelperObject {			   
  ...
  public:
    ...
    TCHAR *GetObjectName() { return _T("Background"); }


    // From Object
           ObjectState Eval(TimeValue time);
    void InitNodeName(TSTR& s) { s = _T("Background"); }
    ...
    void GetClassName(TSTR& s) { s = TSTR(_T("Background")); }
...
#define PB_BG_SIZE             13
#define PB_BG_LENGTH           14
