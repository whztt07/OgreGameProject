...
#define MAXVER_INTERNALNAME "SDKAPWZ\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "SDKAPWZ.awx\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "3ds max Plugin Wizard R5.0\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "\0"//should  be overidden on a per-dll level

#define MAXVER_PRODUCTNAME "3ds max Plugin Wizard R5.0\0"//generally not overridden at the maxversion.r level
