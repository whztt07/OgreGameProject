...
static INT_PTR CALLBACK $$CLASS_NAME$$DlgProc(
      HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
   $$CLASS_NAME$$ParamDlg *ins = DLGetWindowLongPtr<$$CLASS_NAME$$ParamDlg*>(hWnd);
...
INT_PTR CALLBACK $$CLASS_NAME$$OptionsDlgProc(HWND hWnd,UINT message,WPARAM wParam,LPARAM lParam) {
...
INT_PTR CALLBACK $$CLASS_NAME$$CtrlDlgProc(HWND hWnd,UINT message,WPARAM wParam,LPARAM lParam) {
      ...
      HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) 
{
   ...
   if (msg==WM_INITDIALOG) {
      ...
      DLSetWindowLongPtr(hwnd, lParam);
       ...
       if ( (theDlg = DLGetWindowLongPtr<$$CLASS_NAME$$Dlg *>(hwnd) ) == NULL )
         return FALSE; 
      }
...
static INT_PTR CALLBACK $$CLASS_NAME$$DlgProc(
      HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
   $$CLASS_NAME$$ *ins = DLGetWindowLongPtr<$$CLASS_NAME$$*>(hWnd);
   if (!ins && msg!=WM_INITDIALOG) return FALSE;
...
INT_PTR $$CLASS_NAME$$::Control(HWND hWnd,UINT message,WPARAM wParam,LPARAM lParam) 
{
...
static INT_PTR CALLBACK  $$CLASS_NAME$$DlgProc(HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam) {
   $$CLASS_NAME$$Dlg *theDlg;
   if (msg == WM_INITDIALOG) {
      theDlg = ($$CLASS_NAME$$Dlg*)lParam;
      DLSetWindowLongPtr(hwndDlg, lParam);
   } else {
       if ( (theDlg = DLGetWindowLongPtr<$$CLASS_NAME$$Dlg *>(hwndDlg) ) == NULL )
         return FALSE; 
   }
   theDlg->isActive = 1;
...
{
   LONG_PTR id = GetWindowLong(hwnd,GWLP_ID);
...
INT_PTR $$CLASS_NAME$$Dlg::PanelProc(HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam ) 
{
