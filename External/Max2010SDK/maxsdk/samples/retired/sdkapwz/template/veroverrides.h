...
#define MAXVER_INTERNALNAME "$$CLASS_NAME$$\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "$$CLASS_NAME$$.$$PLUGEXT$$\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "$$LIBDESC$$\0"//should  be overidden on a per-dll level
...
#define MAXVER_COPYRIGHT "\0"//only in exceptions should this be overridden
// #define MAXVER_LEGALTRADEMARKS //only in exceptions should this be overridden
#define MAXVER_COMPANYNAME "\0"//only in exceptions should this be overridden
