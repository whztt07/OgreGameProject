...
public:
	...
	void SetMap(const MaxSDK::AssetManagement::AssetUser& asset, bool isUIAction=false);
	...
	****/
	...
	const MaxSDK::AssetManagement::AssetUser& GetMap() ;
	...
	//updates default settings when a new bitmap is picked
	void UpdateDefaults();
