...
class StdMtlDlg: public ParamDlg {
   ...
   INT_PTR ExtraPanelProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam );
   INT_PTR TexmapPanelProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam );
   INT_PTR DynamPanelProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam );
...
StdMtlDlg::~StdMtlDlg() {
   ...
   DLSetWindowLongPtr(hPanelExtra, NULL);
   DLSetWindowLongPtr(hPanelTexmap, NULL);
#ifndef NO_MTL_DYNAMICS_PARAMETERS
   DLSetWindowLongPtr(hPanelDynam, NULL);
#endif
   hPanelBasic = hPanelExtra = hPanelTexmap = hPanelDynam = NULL;
   }
...
static LRESULT CALLBACK HiliteWndProc( HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam ) {
   ...
   StdMtlDlg *theDlg = DLGetWindowLongPtr<StdMtlDlg *>(hwpar);
...
INT_PTR StdMtlDlg::BasicPanelProc(HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam ) {
...
INT_PTR StdMtlDlg::ExtraPanelProc(HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam ) {
   int id = LOWORD(wParam);
   int code = HIWORD(wParam);
    switch (msg)    {
      case WM_INITDIALOG:
...
INT_PTR StdMtlDlg::TexmapPanelProc(HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam ) {
   int id = LOWORD(wParam);
   int code = HIWORD(wParam);
    switch (msg)    {
      case WM_INITDIALOG:{
...
//          WNDPROC oldp = DLGetWindowProc(hw);
//          DLSetWindowLongPtr( hw, TexSlotWndProc);
//          DLSetWindowLongPtr( hw, oldp);
...
INT_PTR StdMtlDlg::DynamPanelProc(HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam ) {
   int id = LOWORD(wParam);
   int code = HIWORD(wParam);
    switch (msg)    {
      case WM_INITDIALOG:
...
static INT_PTR CALLBACK  BasicPanelDlgProc(HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam) {
   ...
   if (msg==WM_INITDIALOG) {
      ...
      DLSetWindowLongPtr(hwndDlg, lParam);
       ...
       if ( (theDlg = DLGetWindowLongPtr<StdMtlDlg *>(hwndDlg) ) == NULL )
         return FALSE; 
      }
   BOOL res;
   theDlg->isActive = 1;
...
void StdMtl::DeleteThis() {
   //DebugPrint(_T(" Deleting STDMTL %d \n"),numStdMtls--);
    delete this;
   }
