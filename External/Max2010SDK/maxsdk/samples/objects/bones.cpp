...
void BonesCreateMode::WriteINI(BoneData &data)
{
	...
	_stprintf(buffer,"%f", data.boneObjWidth);
	WritePrivateProfileString(BONE_OBJECT,BONE_WIDTH, buffer,  filename);
	_stprintf(buffer,"%f", data.boneObjHeight);
	WritePrivateProfileString(BONE_OBJECT,BONE_HEIGHT, buffer, filename);
	_stprintf(buffer,"%f", data.boneObjTaper);
	WritePrivateProfileString(BONE_OBJECT,BONE_TAPER, buffer, filename);

	_stprintf(buffer,"%d", data.boneObjSideFinsEnabled);
	WritePrivateProfileString(BONE_SIDE_FINS,BONE_ENABLED, buffer,  filename);
	_stprintf(buffer,"%f", data.boneObjSideFinsSize);
	WritePrivateProfileString(BONE_SIDE_FINS,BONE_SIZE, buffer,  filename);
	_stprintf(buffer,"%f", data.boneObjSideFinsStartTaper);
	WritePrivateProfileString(BONE_SIDE_FINS,BONE_START_TAPER, buffer,  filename);
	_stprintf(buffer,"%f", data.boneObjSideFinsEndTaper);
	WritePrivateProfileString(BONE_SIDE_FINS,BONE_END_TAPER, buffer,  filename);

	_stprintf(buffer,"%d", data.boneObjFrontFinEnabled);
	WritePrivateProfileString(BONE_FRONT_FIN,BONE_ENABLED, buffer,  filename);
	_stprintf(buffer,"%f", data.boneObjFrontFinSize);
	WritePrivateProfileString(BONE_FRONT_FIN,BONE_SIZE, buffer,  filename);
	_stprintf(buffer,"%f", data.boneObjFrontFinStartTaper);
	WritePrivateProfileString(BONE_FRONT_FIN,BONE_START_TAPER, buffer,  filename);
	_stprintf(buffer,"%f", data.boneObjFrontFinEndTaper);
	WritePrivateProfileString(BONE_FRONT_FIN,BONE_END_TAPER, buffer,  filename);

	_stprintf(buffer,"%d", data.boneObjBackFinEnabled);
	WritePrivateProfileString(BONE_BACK_FIN,BONE_ENABLED, buffer,  filename);
	_stprintf(buffer,"%f", data.boneObjBackFinSize);
	WritePrivateProfileString(BONE_BACK_FIN,BONE_SIZE, buffer,  filename);
	_stprintf(buffer,"%f", data.boneObjBackFinStartTaper);
	WritePrivateProfileString(BONE_BACK_FIN,BONE_START_TAPER, buffer,  filename);
	_stprintf(buffer,"%f", data.boneObjBackFinEndTaper);
	WritePrivateProfileString(BONE_BACK_FIN,BONE_END_TAPER, buffer,  filename);

	_stprintf(buffer,"%d", data.boneObjBoneMapCoordinates);
	WritePrivateProfileString(BONE_MAP_COORDINATES,BONE_ENABLED, buffer,  filename);
...
void BonesCreateMode::ReadINI(BoneData &data)
{
	...
	GetPrivateProfileString(BONE_OBJECT,BONE_WIDTH, buffer, buffer, sizeof(buffer), filename);
    data.boneObjWidth=  atof(buffer);
	GetPrivateProfileString(BONE_OBJECT,BONE_HEIGHT, buffer, buffer, sizeof(buffer), filename);
    data.boneObjHeight=  atof(buffer);
	GetPrivateProfileString(BONE_OBJECT,BONE_TAPER, buffer, buffer, sizeof(buffer), filename);
    data.boneObjTaper=  atof(buffer);

	GetPrivateProfileString(BONE_SIDE_FINS,BONE_ENABLED, buffer, buffer, sizeof(buffer), filename);
    data.boneObjSideFinsEnabled = (BOOL) atoi(buffer);
	GetPrivateProfileString(BONE_SIDE_FINS,BONE_SIZE, buffer, buffer, sizeof(buffer), filename);
    data.boneObjSideFinsSize=  atof(buffer);
	GetPrivateProfileString(BONE_SIDE_FINS,BONE_START_TAPER, buffer, buffer, sizeof(buffer), filename);
    data.boneObjSideFinsStartTaper=  atof(buffer);
	GetPrivateProfileString(BONE_SIDE_FINS,BONE_END_TAPER, buffer, buffer, sizeof(buffer), filename);
    data.boneObjSideFinsEndTaper=  atof(buffer);


	GetPrivateProfileString(BONE_FRONT_FIN,BONE_ENABLED, buffer, buffer, sizeof(buffer), filename);
    data.boneObjFrontFinEnabled = (BOOL) atoi(buffer);
	GetPrivateProfileString(BONE_FRONT_FIN,BONE_SIZE, buffer, buffer, sizeof(buffer), filename);
    data.boneObjFrontFinSize=  atof(buffer);
	GetPrivateProfileString(BONE_FRONT_FIN,BONE_START_TAPER, buffer, buffer, sizeof(buffer), filename);
    data.boneObjFrontFinStartTaper=  atof(buffer);
	GetPrivateProfileString(BONE_FRONT_FIN,BONE_END_TAPER, buffer, buffer, sizeof(buffer), filename);
    data.boneObjFrontFinEndTaper=  atof(buffer);

	
	GetPrivateProfileString(BONE_BACK_FIN,BONE_ENABLED, buffer, buffer, sizeof(buffer), filename);
    data.boneObjBackFinEnabled = (BOOL) atoi(buffer);
	GetPrivateProfileString(BONE_BACK_FIN,BONE_SIZE, buffer, buffer, sizeof(buffer), filename);
    data.boneObjBackFinSize=  atof(buffer);
	GetPrivateProfileString(BONE_BACK_FIN,BONE_START_TAPER, buffer, buffer, sizeof(buffer), filename);
    data.boneObjBackFinStartTaper=  atof(buffer);
	GetPrivateProfileString(BONE_BACK_FIN,BONE_END_TAPER, buffer, buffer, sizeof(buffer), filename);
    data.boneObjBackFinEndTaper=  atof(buffer);

	GetPrivateProfileString(BONE_MAP_COORDINATES,BONE_ENABLED, buffer, buffer, sizeof(buffer), filename);
    data.boneObjBoneMapCoordinates = (BOOL) atoi(buffer);
}
...
//watje
         ...
         else 
         {
            ...
            // one to the closest snap point and update the orientation and legth of its
