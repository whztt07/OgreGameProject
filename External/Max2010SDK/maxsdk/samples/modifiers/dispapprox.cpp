...
// JP Morel - July 23th 2002
// aszabo|Oct.27.2003|DisplaceMesh WSM and Displace Approx have to be either both On or both Off
#if !defined(NO_OUTPUTRENDERER) && !defined( NO_MODIFIER_DISP_APPROX ) && !defined(NO_WSM_DISPLACEMESH)
#include "MeshDLib.h"
#endif
...
#endif // !NO_OUTPUTRENDERER) && !NO_MODIFIER_DISP_APPROX 
