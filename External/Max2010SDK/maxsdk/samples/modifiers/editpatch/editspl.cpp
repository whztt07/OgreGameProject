...
//copy over binds + offset
   for (int i = 0; i < attShape->bindList.Count();i++)
      {
...
//watje
   ...
   // CAL-05/23/03: Add Connecting Splines when Shift-Move Copy. (FID #827)
#ifdef SPLINE_ADD_CONNECTING_LINES_ON_MOVE
   ...
   ReleaseISpinner(spin);
#endif // SPLINE_ADD_CONNECTING_LINES_ON_MOVE

   // CAL-03/03/03: copy/paste tangent. (FID #827)
#ifdef SPLINE_COPY_PASTE_TANGENT
...
#endif // SPLINE_COPY_PASTE_TANGENT
...
//2-1-99 watje
         ...
         case IDC_ES_CROSS_SECTION:
               ...
               break;
#endif //#ifdef SPLINE_ADD_CROSS_SECTION
...
BOOL EditSplineMod::PasteTangent(BezierShape *shape, int poly, int vert)
{
   ...
   ip->RedrawViews(ip->GetTime(), REDRAW_NORMAL);
   return TRUE;
#else // SPLINE_COPY_PASTE_TANGENT
   return FALSE;
#endif // SPLINE_COPY_PASTE_TANGENT
