...
//BOOL ImportFile(const MCHAR *buf = NULL, BOOL suppressPrompts=FALSE, Class_ID *importerID=NULL);
//BOOL ExportFile(const MCHAR *buf = NULL, BOOL suppressPrompts=FALSE, DWORD options=0, Class_ID *exporterID=NULL);
// Use
//    BOOL Interface::ImportFromFile(const MCHAR *name, BOOL suppressPrompts=FALSE, Class_ID *importerID=NULL);
//    BOOL Interface::ExportToFile(const MCHAR *name, BOOL suppressPrompts=FALSE, DWORD options=0, Class_ID *exporterID=NULL);
// instead.			   // 020517  --prs.
