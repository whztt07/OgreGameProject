 ...
 */
template <typename Type>
class ArrayAutoPtr : public AutoPtr<Type, ArrayPointerDestructor<Type> > 
{
public:
	/*!
	 * \brief Construct, assuming ownership of the pointed-to object.
 ...
 */
template <typename Type>
class DeleteThisAutoPtr : public AutoPtr<Type, DeleteThisDestructor > 
{
public:
	/*!
	 * \brief Construct, assuming ownership of the pointed-to object.
 ...
 */
template<typename Type>
class AutoPtr : public MaxSDK::AutoPtr<Type>
{
public:
	/*!
	 * \brief Construct, assuming ownership of the pointed-to object.
